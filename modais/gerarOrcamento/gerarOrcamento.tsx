...
export default function GerarOrcamento({ sair, produtos }: GerarOrcamentoProps) {
    ...
    dataFutura.setDate(hoje.getDate() + 7)
    ...
    const [validade, setValidade] = useState(formatar(dataFutura))
    ...
    const [txEntrga, setTxEntrega] = useState(0)
    ...
    const enviar = async () => {
        ...
        if (!nome || !validade || produtosAdicionados.length == 0 || entrega && !endereco) {
        ...
        const dadosParaOBack = {
            ...
            totalFinal: totalItens - ((totalItens / 100) * desconto) + txEntrga,
            obs: observacao,
            endereco
        }

        const res = await api.post('/gerar/orcamento', dadosParaOBack)
    ...
    return <div className="Cortina" onClick={sair}>
        ...
        <div className="Container" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="TituloModal">Gerar Orçamentos!!</h3>
            ...
            <div className="orcamentoContainer">
                ...
                <div className='tabela'>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        ...
                        <label>Total
                            <input type="text" value={formatarValor(totalItens - ((totalItens / 100) * desconto) + txEntrga)} />
                        </label>
                    </div>
